  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        ...
        p.mb-4 Reforzar los conceptos básicos y demás elementos teóricos sobre el estudio del trabajo y su aplicación en los sistemas de producción, desarrollados en el componente formativo. 
